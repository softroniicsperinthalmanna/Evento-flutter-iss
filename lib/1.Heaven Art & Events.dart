...
class HeavenArt extends StatefulWidget {
  const HeavenArt({super.key});

  @override
  State<HeavenArt> createState() => _HeavenArtState();
}

class _HeavenArtState extends State<HeavenArt> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(children: [
        ...
        Padding(
          padding: EdgeInsets.only(top: 420.h, left: 260.w),
          child: Container(
              width: 90.w,
              height: 30.h,
              decoration: BoxDecoration(
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Container(
                        height: 100.h,
                        width: 250.w,
                        decoration: BoxDecoration(border: Border.all(width: 2)),child:  Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Column(
                            children: [
